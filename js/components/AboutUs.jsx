    ...
    return <section id='about-us'>
      <div className='container'>
        ...
        <div className='col-6 section-about-us'>
          ...
          <div className='about-us'><h4><a href='#'>Our Locations</a></h4><p>Aliquam erat ac ipsum. Integer aliquam purus. Quisque lorem tortor fringilla sed, vestibulum id, eleifend justo vel bibendum sapien. Aliquam sem. In hendrerit nulla quam nunc, accumsan congue.</p><p className='read-more'><a>read more...</a></p></div>
        </div>
        </main>
      </div>
    </section>
