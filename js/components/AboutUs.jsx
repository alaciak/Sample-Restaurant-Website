    ...
    return <section id='about-us'>
      <div className='container'>
        ...
        <div className='col-6 section-about-us'>
          ...
          <div id='menu' className='about-us'><h4><a href='#'>Our Menu</a></h4><p>Nulla imperdiet sit amet magna. Vestibulum dapibus, mauris nec malesuada fames ac turpis velit, rhoncus eu, luctus et interdum adipiscing wisi. Aliquam sem. In hendrerit nulla quam nunc, accumsan congue.</p><p className='read-more'><a href='#'>read more...</a></p></div>
          ...
          <div className='about-us'><h4><a href='#'>Our Recipes</a></h4><p>Aliquam erat ac ipsum. Integer aliquam purus. Quisque lorem tortor fringilla sed, vestibulum id, eleifend justo vel bibendum sapien. Aliquam sem. In hendrerit nulla quam nunc, accumsan congue.</p><p className='read-more'><a href='#'>read more...</a></p></div>
        </div>
        </main>
      </div>
    </section>
